 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Dy;function fA(){if(Dy)return ul;Dy=1;var n=yp(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,o=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,a={key:!0,ref:!0,__self:!0,__source:!0};function c(d,f,g){var v,E={},T=null,S=null;g!==void 0&&(T=""+g),f.key!==void 0&&(T=""+f.key),f.ref!==void 0&&(S=f.ref);for(v in f)i.call(f,v)&&!a.hasOwnProperty(v)&&(E[v]=f[v]);if(d&&d.defaultProps)for(v in f=d.defaultProps,f)E[v]===void 0&&(E[v]=f[v]);return{$$typeof:e,type:d,key:T,ref:S,props:E,_owner:o.current}}return ul.Fragment=t,ul.jsx=c,ul.jsxs=c,ul}var Oy;function pA(){return Oy||(Oy=1,pf.exports=fA()),pf.exports}var J=pA(),q=yp();const Ye=hA(q);var cl={},Ly;function mA(){if(Ly)return cl;Ly=1,Object.defineProperty(cl,"__esModule",{value:!0}),cl.parse=c,cl.serialize=g;const n=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,e=/^[\u0021-\u003A\u003C-\u007E]*$/,t=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,i=/^[\u0020-\u003A\u003D-\u007E]*$/,o=Object.prototype.toString,a=(()=>{const T=function(){};return T.prototype=Object.create(null),T})();function c(T,S){const b=new a,V=T.length;if(V<2)return b;const k=(S==null?void 0:S.decode)||v;let M=0;do{const U=T.indexOf("=",M);if(U===-1)break;const H=T.indexOf(";",M),K=H===-1?V:H;if(U>K){M=T.lastIndexOf(";",U-1)+1;continue}const se=d(T,M,U),oe=f(T,U,se),P=T.slice(se,oe);if(b[P]===void 0){let A=d(T,U+1,K),R=f(T,K,A);const N=k(T.slice(A,R));b[P]=N}M=K+1}while(M<V);return b}function d(T,S,b){do{const V=T.charCodeAt(S);if(V!==32&&V!==9)return S}while(++S<b);return b}function f(T,S,b){for(;S>b;){const V=T.charCodeAt(--S);if(V!==32&&V!==9)return S+1}return b}function g(T,S,b){const V=(b==null?void 0:b.encode)||encodeURIComponent;if(!n.test(T))throw new TypeError(`argument name is invalid: ${T}`);const k=V(S);if(!e.test(k))throw new TypeError(`argument val is invalid: ${S}`);let M=T+"="+k;if(!b)return M;if(b.maxAge!==void 0){if(!Number.isInteger(b.maxAge))throw new TypeError(`option maxAge is invalid: ${b.maxAge}`);M+="; Max-Age="+b.maxAge}if(b.domain){if(!t.test(b.domain))throw new TypeError(`option domain is invalid: ${b.domain}`);M+="; Domain="+b.domain}if(b.path){if(!i.test(b.path))throw new TypeError(`option path is invalid: ${b.path}`);M+="; Path="+b.path}if(b.expires){if(!E(b.expires)||!Number.isFinite(b.expires.valueOf()))throw new TypeError(`option expires is invalid: ${b.expires}`);M+="; Expires="+b.expires.toUTCString()}if(b.httpOnly&&(M+="; HttpOnly"),b.secure&&(M+="; Secure"),b.partitioned&&(M+="; Partitioned"),b.priority)switch(typeof b.priority=="string"?b.priority.toLowerCase():void 0){case"low":M+="; Priority=Low";break;case"medium":M+="; Priority=Medium";break;case"high":M+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${b.priority}`)}if(b.sameSite)switch(typeof b.sameSite=="string"?b.sameSite.toLowerCase():b.sameSite){case!0:case"strict":M+="; SameSite=Strict";break;case"lax":M+="; SameSite=Lax";break;case"none":M+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${b.sameSite}`)}return M}function v(T){if(T.indexOf("%")===-1)return T;try{return decodeURIComponent(T)}catch{return T}}function E(T){return o.call(T)==="[object Date]"}return cl}mA();/**
 * react-router v7.1.2
 *
...
*/var Ui,ow;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(P,A){function R(){}R.prototype=A.prototype,P.D=A.prototype,P.prototype=new R,P.prototype.constructor=P,P.C=function(N,O,F){for(var x=Array(arguments.length-2),tt=2;tt<arguments.length;tt++)x[tt-2]=arguments[tt];return A.prototype[O].apply(N,x)}}function t(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(i,t),i.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(P,A,R){R||(R=0);var N=Array(16);if(typeof A=="string")for(var O=0;16>O;++O)N[O]=A.charCodeAt(R++)|A.charCodeAt(R++)<<8|A.charCodeAt(R++)<<16|A.charCodeAt(R++)<<24;else for(O=0;16>O;++O)N[O]=A[R++]|A[R++]<<8|A[R++]<<16|A[R++]<<24;A=P.g[0],R=P.g[1],O=P.g[2];var F=P.g[3],x=A+(F^R&(O^F))+N[0]+3614090360&4294967295;A=R+(x<<7&4294967295|x>>>25),x=F+(O^A&(R^O))+N[1]+3905402710&4294967295,F=A+(x<<12&4294967295|x>>>20),x=O+(R^F&(A^R))+N[2]+606105819&4294967295,O=F+(x<<17&4294967295|x>>>15),x=R+(A^O&(F^A))+N[3]+3250441966&4294967295,R=O+(x<<22&4294967295|x>>>10),x=A+(F^R&(O^F))+N[4]+4118548399&4294967295,A=R+(x<<7&4294967295|x>>>25),x=F+(O^A&(R^O))+N[5]+1200080426&4294967295,F=A+(x<<12&4294967295|x>>>20),x=O+(R^F&(A^R))+N[6]+2821735955&4294967295,O=F+(x<<17&4294967295|x>>>15),x=R+(A^O&(F^A))+N[7]+4249261313&4294967295,R=O+(x<<22&4294967295|x>>>10),x=A+(F^R&(O^F))+N[8]+1770035416&4294967295,A=R+(x<<7&4294967295|x>>>25),x=F+(O^A&(R^O))+N[9]+2336552879&4294967295,F=A+(x<<12&4294967295|x>>>20),x=O+(R^F&(A^R))+N[10]+4294925233&4294967295,O=F+(x<<17&4294967295|x>>>15),x=R+(A^O&(F^A))+N[11]+2304563134&4294967295,R=O+(x<<22&4294967295|x>>>10),x=A+(F^R&(O^F))+N[12]+1804603682&4294967295,A=R+(x<<7&4294967295|x>>>25),x=F+(O^A&(R^O))+N[13]+4254626195&4294967295,F=A+(x<<12&4294967295|x>>>20),x=O+(R^F&(A^R))+N[14]+2792965006&4294967295,O=F+(x<<17&4294967295|x>>>15),x=R+(A^O&(F^A))+N[15]+1236535329&4294967295,R=O+(x<<22&4294967295|x>>>10),x=A+(O^F&(R^O))+N[1]+4129170786&4294967295,A=R+(x<<5&4294967295|x>>>27),x=F+(R^O&(A^R))+N[6]+3225465664&4294967295,F=A+(x<<9&4294967295|x>>>23),x=O+(A^R&(F^A))+N[11]+643717713&4294967295,O=F+(x<<14&4294967295|x>>>18),x=R+(F^A&(O^F))+N[0]+3921069994&4294967295,R=O+(x<<20&4294967295|x>>>12),x=A+(O^F&(R^O))+N[5]+3593408605&4294967295,A=R+(x<<5&4294967295|x>>>27),x=F+(R^O&(A^R))+N[10]+38016083&4294967295,F=A+(x<<9&4294967295|x>>>23),x=O+(A^R&(F^A))+N[15]+3634488961&4294967295,O=F+(x<<14&4294967295|x>>>18),x=R+(F^A&(O^F))+N[4]+3889429448&4294967295,R=O+(x<<20&4294967295|x>>>12),x=A+(O^F&(R^O))+N[9]+568446438&4294967295,A=R+(x<<5&4294967295|x>>>27),x=F+(R^O&(A^R))+N[14]+3275163606&4294967295,F=A+(x<<9&4294967295|x>>>23),x=O+(A^R&(F^A))+N[3]+4107603335&4294967295,O=F+(x<<14&4294967295|x>>>18),x=R+(F^A&(O^F))+N[8]+1163531501&4294967295,R=O+(x<<20&4294967295|x>>>12),x=A+(O^F&(R^O))+N[13]+2850285829&4294967295,A=R+(x<<5&4294967295|x>>>27),x=F+(R^O&(A^R))+N[2]+4243563512&4294967295,F=A+(x<<9&4294967295|x>>>23),x=O+(A^R&(F^A))+N[7]+1735328473&4294967295,O=F+(x<<14&4294967295|x>>>18),x=R+(F^A&(O^F))+N[12]+2368359562&4294967295,R=O+(x<<20&4294967295|x>>>12),x=A+(R^O^F)+N[5]+4294588738&4294967295,A=R+(x<<4&4294967295|x>>>28),x=F+(A^R^O)+N[8]+2272392833&4294967295,F=A+(x<<11&4294967295|x>>>21),x=O+(F^A^R)+N[11]+1839030562&4294967295,O=F+(x<<16&4294967295|x>>>16),x=R+(O^F^A)+N[14]+4259657740&4294967295,R=O+(x<<23&4294967295|x>>>9),x=A+(R^O^F)+N[1]+2763975236&4294967295,A=R+(x<<4&4294967295|x>>>28),x=F+(A^R^O)+N[4]+1272893353&4294967295,F=A+(x<<11&4294967295|x>>>21),x=O+(F^A^R)+N[7]+4139469664&4294967295,O=F+(x<<16&4294967295|x>>>16),x=R+(O^F^A)+N[10]+3200236656&4294967295,R=O+(x<<23&4294967295|x>>>9),x=A+(R^O^F)+N[13]+681279174&4294967295,A=R+(x<<4&4294967295|x>>>28),x=F+(A^R^O)+N[0]+3936430074&4294967295,F=A+(x<<11&4294967295|x>>>21),x=O+(F^A^R)+N[3]+3572445317&4294967295,O=F+(x<<16&4294967295|x>>>16),x=R+(O^F^A)+N[6]+76029189&4294967295,R=O+(x<<23&4294967295|x>>>9),x=A+(R^O^F)+N[9]+3654602809&4294967295,A=R+(x<<4&4294967295|x>>>28),x=F+(A^R^O)+N[12]+3873151461&4294967295,F=A+(x<<11&4294967295|x>>>21),x=O+(F^A^R)+N[15]+530742520&4294967295,O=F+(x<<16&4294967295|x>>>16),x=R+(O^F^A)+N[2]+3299628645&4294967295,R=O+(x<<23&4294967295|x>>>9),x=A+(O^(R|~F))+N[0]+4096336452&4294967295,A=R+(x<<6&4294967295|x>>>26),x=F+(R^(A|~O))+N[7]+1126891415&4294967295,F=A+(x<<10&4294967295|x>>>22),x=O+(A^(F|~R))+N[14]+2878612391&4294967295,O=F+(x<<15&4294967295|x>>>17),x=R+(F^(O|~A))+N[5]+4237533241&4294967295,R=O+(x<<21&4294967295|x>>>11),x=A+(O^(R|~F))+N[12]+1700485571&4294967295,A=R+(x<<6&4294967295|x>>>26),x=F+(R^(A|~O))+N[3]+2399980690&4294967295,F=A+(x<<10&4294967295|x>>>22),x=O+(A^(F|~R))+N[10]+4293915773&4294967295,O=F+(x<<15&4294967295|x>>>17),x=R+(F^(O|~A))+N[1]+2240044497&4294967295,R=O+(x<<21&4294967295|x>>>11),x=A+(O^(R|~F))+N[8]+1873313359&4294967295,A=R+(x<<6&4294967295|x>>>26),x=F+(R^(A|~O))+N[15]+4264355552&4294967295,F=A+(x<<10&4294967295|x>>>22),x=O+(A^(F|~R))+N[6]+2734768916&4294967295,O=F+(x<<15&4294967295|x>>>17),x=R+(F^(O|~A))+N[13]+1309151649&4294967295,R=O+(x<<21&4294967295|x>>>11),x=A+(O^(R|~F))+N[4]+4149444226&4294967295,A=R+(x<<6&4294967295|x>>>26),x=F+(R^(A|~O))+N[11]+3174756917&4294967295,F=A+(x<<10&4294967295|x>>>22),x=O+(A^(F|~R))+N[2]+718787259&4294967295,O=F+(x<<15&4294967295|x>>>17),x=R+(F^(O|~A))+N[9]+3951481745&4294967295,P.g[0]=P.g[0]+A&4294967295,P.g[1]=P.g[1]+(O+(x<<21&4294967295|x>>>11))&4294967295,P.g[2]=P.g[2]+O&4294967295,P.g[3]=P.g[3]+F&4294967295}i.prototype.u=function(P,A){A===void 0&&(A=P.length);for(var R=A-this.blockSize,N=this.B,O=this.h,F=0;F<A;){if(O==0)for(;F<=R;)o(this,P,F),F+=this.blockSize;if(typeof P=="string"){for(;F<A;)if(N[O++]=P.charCodeAt(F++),O==this.blockSize){o(this,N),O=0;break}}else for(;F<A;)if(N[O++]=P[F++],O==this.blockSize){o(this,N),O=0;break}}this.h=O,this.o+=A},i.prototype.v=function(){var P=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);P[0]=128;for(var A=1;A<P.length-8;++A)P[A]=0;var R=8*this.o;for(A=P.length-8;A<P.length;++A)P[A]=R&255,R/=256;for(this.u(P),P=Array(16),A=R=0;4>A;++A)for(var N=0;32>N;N+=8)P[R++]=this.g[A]>>>N&255;return P};function a(P,A){var R=d;return Object.prototype.hasOwnProperty.call(R,P)?R[P]:R[P]=A(P)}function c(P,A){this.h=A;for(var R=[],N=!0,O=P.length-1;0<=O;O--){var F=P[O]|0;N&&F==A||(R[O]=F,N=!1)}this.g=R}var d={};function f(P){return-128<=P&&128>P?a(P,function(A){return new c([A|0],0>A?-1:0)}):new c([P|0],0>P?-1:0)}function g(P){if(isNaN(P)||!isFinite(P))return E;if(0>P)return k(g(-P));for(var A=[],R=1,N=0;P>=R;N++)A[N]=P/R|0,R*=4294967296;return new c(A,0)}function v(P,A){if(P.length==0)throw Error("number format error: empty string");if(A=A||10,2>A||36<A)throw Error("radix out of range: "+A);if(P.charAt(0)=="-")return k(v(P.substring(1),A));if(0<=P.indexOf("-"))throw Error('number format error: interior "-" character');for(var R=g(Math.pow(A,8)),N=E,O=0;O<P.length;O+=8){var F=Math.min(8,P.length-O),x=parseInt(P.substring(O,O+F),A);8>F?(F=g(Math.pow(A,F)),N=N.j(F).add(g(x))):(N=N.j(R),N=N.add(g(x)))}return N}var E=f(0),T=f(1),S=f(16777216);n=c.prototype,n.m=function(){if(V(this))return-k(this).m();for(var P=0,A=1,R=0;R<this.g.length;R++){var N=this.i(R);P+=(0<=N?N:4294967296+N)*A,A*=4294967296}return P},n.toString=function(P){if(P=P||10,2>P||36<P)throw Error("radix out of range: "+P);if(b(this))return"0";if(V(this))return"-"+k(this).toString(P);for(var A=g(Math.pow(P,6)),R=this,N="";;){var O=K(R,A).g;R=M(R,O.j(A));var F=((0<R.g.length?R.g[0]:R.h)>>>0).toString(P);if(R=O,b(R))return F+N;for(;6>F.length;)F="0"+F;N=F+N}},n.i=function(P){return 0>P?0:P<this.g.length?this.g[P]:this.h};function b(P){if(P.h!=0)return!1;for(var A=0;A<P.g.length;A++)if(P.g[A]!=0)return!1;return!0}function V(P){return P.h==-1}n.l=function(P){return P=M(this,P),V(P)?-1:b(P)?0:1};function k(P){for(var A=P.g.length,R=[],N=0;N<A;N++)R[N]=~P.g[N];return new c(R,~P.h).add(T)}n.abs=function(){return V(this)?k(this):this},n.add=function(P){for(var A=Math.max(this.g.length,P.g.length),R=[],N=0,O=0;O<=A;O++){var F=N+(this.i(O)&65535)+(P.i(O)&65535),x=(F>>>16)+(this.i(O)>>>16)+(P.i(O)>>>16);N=x>>>16,F&=65535,x&=65535,R[O]=x<<16|F}return new c(R,R[R.length-1]&-2147483648?-1:0)};function M(P,A){return P.add(k(A))}n.j=function(P){if(b(this)||b(P))return E;if(V(this))return V(P)?k(this).j(k(P)):k(k(this).j(P));if(V(P))return k(this.j(k(P)));if(0>this.l(S)&&0>P.l(S))return g(this.m()*P.m());for(var A=this.g.length+P.g.length,R=[],N=0;N<2*A;N++)R[N]=0;for(N=0;N<this.g.length;N++)for(var O=0;O<P.g.length;O++){var F=this.i(N)>>>16,x=this.i(N)&65535,tt=P.i(O)>>>16,mt=P.i(O)&65535;R[2*N+2*O]+=x*mt,U(R,2*N+2*O),R[2*N+2*O+1]+=F*mt,U(R,2*N+2*O+1),R[2*N+2*O+1]+=x*tt,U(R,2*N+2*O+1),R[2*N+2*O+2]+=F*tt,U(R,2*N+2*O+2)}for(N=0;N<A;N++)R[N]=R[2*N+1]<<16|R[2*N];for(N=A;N<2*A;N++)R[N]=0;return new c(R,0)};function U(P,A){for(;(P[A]&65535)!=P[A];)P[A+1]+=P[A]>>>16,P[A]&=65535,A++}function H(P,A){this.g=P,this.h=A}function K(P,A){if(b(A))throw Error("division by zero");if(b(P))return new H(E,E);if(V(P))return A=K(k(P),A),new H(k(A.g),k(A.h));if(V(A))return A=K(P,k(A)),new H(k(A.g),A.h);if(30<P.g.length){if(V(P)||V(A))throw Error("slowDivide_ only works with positive integers.");for(var R=T,N=A;0>=N.l(P);)R=se(R),N=se(N);var O=oe(R,1),F=oe(N,1);for(N=oe(N,2),R=oe(R,2);!b(N);){var x=F.add(N);0>=x.l(P)&&(O=O.add(R),F=x),N=oe(N,1),R=oe(R,1)}return A=M(P,O.j(A)),new H(O,A)}for(O=E;0<=P.l(A);){for(R=Math.max(1,Math.floor(P.m()/A.m())),N=Math.ceil(Math.log(R)/Math.LN2),N=48>=N?1:Math.pow(2,N-48),F=g(R),x=F.j(A);V(x)||0<x.l(P);)R-=N,F=g(R),x=F.j(A);b(F)&&(F=T),O=O.add(F),P=M(P,x)}return new H(O,P)}n.A=function(P){return K(this,P).h},n.and=function(P){for(var A=Math.max(this.g.length,P.g.length),R=[],N=0;N<A;N++)R[N]=this.i(N)&P.i(N);return new c(R,this.h&P.h)},n.or=function(P){for(var A=Math.max(this.g.length,P.g.length),R=[],N=0;N<A;N++)R[N]=this.i(N)|P.i(N);return new c(R,this.h|P.h)},n.xor=function(P){for(var A=Math.max(this.g.length,P.g.length),R=[],N=0;N<A;N++)R[N]=this.i(N)^P.i(N);return new c(R,this.h^P.h)};function se(P){for(var A=P.g.length+1,R=[],N=0;N<A;N++)R[N]=P.i(N)<<1|P.i(N-1)>>>31;return new c(R,P.h)}function oe(P,A){var R=A>>5;A%=32;for(var N=P.g.length-R,O=[],F=0;F<N;F++)O[F]=0<A?P.i(F+R)>>>A|P.i(F+R+1)<<32-A:P.i(F+R);return new c(O,P.h)}i.prototype.digest=i.prototype.v,i.prototype.reset=i.prototype.s,i.prototype.update=i.prototype.u,ow=i,c.prototype.add=c.prototype.add,c.prototype.multiply=c.prototype.j,c.prototype.modulo=c.prototype.A,c.prototype.compare=c.prototype.l,c.prototype.toNumber=c.prototype.m,c.prototype.toString=c.prototype.toString,c.prototype.getBits=c.prototype.i,c.fromNumber=g,c.fromString=v,Ui=c}).apply(typeof r_<"u"?r_:typeof self<"u"?self:typeof window<"u"?window:{});var yc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MD(n,e,t){let i=1,o=null,a=null,c=!1,d=0;function f(){return d===2}let g=!1;function v(...k){g||(g=!0,e.apply(null,k))}function E(k){o=setTimeout(()=>{o=null,n(S,f())},k)}function T(){a&&clearTimeout(a)}function S(k,...M){if(g){T();return}if(k){T(),v.call(null,k,...M);return}if(f()||c){T(),v.call(null,k,...M);return}i<64&&(i*=2);let H;d===1?(d=2,H=0):H=(i+Math.random())*1e3,E(H)}let b=!1;function V(k){b||(b=!0,T(),!g&&(o!==null?(k||(d=2),clearTimeout(o),E(0)):k||(d=1)))}return E(0),a=setTimeout(()=>{c=!0,V(!0)},t),V}function UD(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,T=`\r
--`+f+"--",S=Oi.getBlob(E,i,T);if(S===null)throw GT();const b={name:g.fullPath},V=Jl(a,n.host,n._protocol),k="POST",M=n.maxUploadRetryTime,U=new pa(V,k,Tm(n,t),M);return U.urlParams=b,U.headers=c,U.body=S.uploadData(),U.errorHandler=Zl(e),U}class ah{constructor(e,t,i,o){this.current=e,this.total=t,this.finalized=!!i,this.metadata=o||null}}function Im(n,e){let t=null;try{t=n.getResponseHeader("X-Goog-Upload-Status")}catch{Qr(!1)}return Qr(!!t&&(e||["active"]).indexOf(t)!==-1),t}function mO(n,e,t,i,o){const a=e.bucketOnlyServerUrl(),c=oI(e,i,o),d={name:c.fullPath},f=Jl(a,n.host,n._protocol),g="POST",v={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${i.size()}`,"X-Goog-Upload-Header-Content-Type":c.contentType,"Content-Type":"application/json; charset=utf-8"},E=iI(c,t),T=n.maxUploadRetryTime;function S(V){Im(V);let k;try{k=V.getResponseHeader("X-Goog-Upload-URL")}catch{Qr(!1)}return Qr(Bh(k)),k}const b=new pa(f,g,S,T);return b.urlParams=d,b.headers=v,b.body=E,b.errorHandler=Zl(e),b}function gO(n,e,t,i){const o={"X-Goog-Upload-Command":"query"};function a(g){const v=Im(g,["active","final"]);let E=null;try{E=g.getResponseHeader("X-Goog-Upload-Size-Received")}catch{Qr(!1)}E||Qr(!1);const T=Number(E);return Qr(!isNaN(T)),new ah(T,i.size(),v==="final")}const c="POST",d=n.maxUploadRetryTime,f=new pa(t,c,a,d);return f.headers=o,f.errorHandler=Zl(e),f}const Iv=256*1024;function yO(n,e,t,i,o,a,c,d){const f=new ah(0,0);if(c?(f.current=c.current,f.total=c.total):(f.current=0,f.total=i.size()),i.size()!==f.total)throw bD();const g=f.total-f.current;let v=g;o>0&&(v=Math.min(v,o));const E=f.current,T=E+v;let S="";v===0?S="finalize":g===v?S="upload, finalize":S="upload";const b={"X-Goog-Upload-Command":S,"X-Goog-Upload-Offset":`${f.current}`},V=i.slice(E,T);if(V===null)throw GT();function k(K,se){const oe=Im(K,["active","final"]),P=f.current+v,A=i.size();let R;return oe==="final"?R=Tm(e,a)(K,se):R=null,new ah(P,A,oe==="final",R)}const M="POST",U=e.maxUploadRetryTime,H=new pa(t,M,k,U);return H.headers=b,H.body=V.uploadData(),H.progressCallback=d||null,H.errorHandler=Zl(n),H}const cn={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function Mf(n){switch(n){case"running":case"pausing":case"canceling":return cn.RUNNING;case"paused":return cn.PAUSED;case"success":return cn.SUCCESS;case"canceled":return cn.CANCELED;case"error":return cn.ERROR;default:return cn.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
